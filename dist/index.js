...
function useElementPicker(onSelect) {
  ...
  const lastHoveredRef = react.useRef(null);
  const updateHighlight = react.useCallback((element) => {
    if (!element) {
...
function useScreenshot() {
  ...
  const capture = react.useCallback(async (element) => {
    setIsCapturing(true);
    setError(null);
    try {
      const targetElement = element || document.body;
      const canvas = await html2canvas__default.default(targetElement, {
...
function useContextCapture(options = {}) {
  ...
  const [lastReportMethod, setLastReportMethod] = react.useState(null);
  const [error, setError] = react.useState(null);
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(
          "svg",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntime.jsx("line", { x1: "22", y1: "12", x2: "18", y2: "12" }),
              /* @__PURE__ */ jsxRuntime.jsx("line", { x1: "6", y1: "12", x2: "2", y2: "12" }),
              /* @__PURE__ */ jsxRuntime.jsx("line", { x1: "12", y1: "6", x2: "12", y2: "2" }),
              /* @__PURE__ */ jsxRuntime.jsx("line", { x1: "12", y1: "22", x2: "12", y2: "18" })
            ]
          }
        )
      )
...
function ElementPicker({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    ...
    highlightPosition && /* @__PURE__ */ jsxRuntime.jsx(
      "div",
      {
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx("span", { children: "Click on an element to capture context" }),
          /* @__PURE__ */ jsxRuntime.jsx("span", { style: { opacity: 0.7, marginLeft: 8 }, children: "Press Esc to cancel" })
        ]
      }
    )
  ] });
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntime.jsxs(
                    "button",
                    {
                      ...
                      children: [
                        "Capture",
                        /* @__PURE__ */ jsxRuntime.jsxs("span", { style: { opacity: 0.7, marginLeft: 8, fontSize: 12 }, children: [
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntime.jsx("div", { children: "Context captured!" }),
          /* @__PURE__ */ jsxRuntime.jsx("div", { style: { fontSize: 12, opacity: 0.8, marginTop: 2 }, children: isServer ? /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
            "Saved to ",
            /* @__PURE__ */ jsxRuntime.jsx("code", { style: { fontFamily: "monospace" }, children: "./reports/" })
          ] }) : /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
            "Run ",
            /* @__PURE__ */ jsxRuntime.jsx("code", { style: { fontFamily: "monospace" }, children: "/context-reports" }),
            " in Claude Code"
          ] }) })
        ] })
      ]
...
function ContextReporter({
  ...
  const [lastReportId, setLastReportId] = react.useState("");
  const [toastMethod, setToastMethod] = react.useState("console");
  ...
  const handleElementSelected = react.useCallback((element) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { "data-context-reporter": "root", children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      FloatingButton,
      {
        position,
    ...
    isCapturing && /* @__PURE__ */ jsxRuntime.jsx(
      "div",
      {
...
exports.CONSOLE_TAGS = CONSOLE_TAGS;
exports.CaptureToast = CaptureToast;
exports.ContextReporter = ContextReporter;
exports.DescriptionModal = DescriptionModal;
exports.ElementPicker = ElementPicker;
exports.FloatingButton = FloatingButton;
exports.clearServerCache = clearServerCache;
exports.clearStoredReports = clearStoredReports;
exports.exposeJotaiStore = exposeJotaiStore;
exports.exposeReduxStore = exposeReduxStore;
exports.exposeZustandStore = exposeZustandStore;
exports.getStoredReports = getStoredReports;
exports.isServerAvailable = isServerAvailable;
exports.useContextCapture = useContextCapture;
exports.useElementPicker = useElementPicker;
